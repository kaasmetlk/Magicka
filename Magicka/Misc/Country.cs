...
namespace Magicka.Misc
{
	...
	{
		// Token: 0x06001CDA RID: 7386 RVA: 0x000CABBC File Offset: 0x000C8DBC
		private Country(string iName, string iTwoLetterCode, string iThreeLetterCode, string iNumericCode)
		{
			this.Name = iName;
			this.TwoLetterCode = iTwoLetterCode;
			this.ThreeLetterCode = iThreeLetterCode;
			this.NumericCode = iNumericCode;
		}
		...
		public static readonly Country[] List = new Country[]
		{
			...
			new Country("Saint Martin", "MF", "MAF", "663"),
			...
			new Country("Sint Maarten", "SX", "SXM", "534"),
