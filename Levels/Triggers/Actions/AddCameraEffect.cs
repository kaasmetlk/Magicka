...
// Type: Magicka.Levels.Triggers.Actions.AddCameraEffect
...
public class AddCameraEffect(Trigger iTrigger, GameScene iScene) : Action(iTrigger, iScene)
{
  ...
  {
    this.GameScene.PlayState.Camera.StartVisualEffect(this.mCameraEffectHash);
  }
