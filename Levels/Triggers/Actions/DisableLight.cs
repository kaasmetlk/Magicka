...
// Type: Magicka.Levels.Triggers.Actions.DisableLight
...
internal class DisableLight(Trigger iTrigger, GameScene iScene) : Action(iTrigger, iScene)
{
  ...
  protected override void Execute()
  {
    for (int index = 0; index < this.mLightIDs.Length; ++index)
      this.GameScene.LevelModel.Lights[this.mLightIDs[index]].Disable(this.mEffect, this.mTime);
  }

  public override void QuickExecute()
  {
    for (int index = 0; index < this.mLightIDs.Length; ++index)
      this.GameScene.LevelModel.Lights[this.mLightIDs[index]].Disable(LightTransitionType.None, 0.0f);
  }
