...
// Type: Magicka.Levels.Triggers.Actions.Overkill
...
public class Overkill(Trigger iTrigger, GameScene iScene, XmlNode iNode) : Action(iTrigger, iScene)
{
  ...
  protected override void Execute()
  {
    ...
    else
    {
      ...
      for (int iIndex = 0; iIndex < triggerArea.PresentCharacters.Count; ++iIndex)
      {
        ...
        if (presentCharacter != null && (this.mTypeHash == Overkill.ANYID || presentCharacter.Type == this.mTypeHash || (presentCharacter.GetOriginalFaction & this.mFactions) != Factions.NONE))
          presentCharacter.OverKill();
      }
    }
  }
