...
// Type: Magicka.Levels.Triggers.Actions.TelemetryTutorialStep
...
public class TelemetryTutorialStep(Trigger iTrigger, GameScene iScene) : Action(iTrigger, iScene)
{
  ...
  protected override void Execute() => TutorialUtils.Step(this.mTutorialName, this.mStepName);
