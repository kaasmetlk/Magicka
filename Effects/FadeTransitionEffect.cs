...
// Type: PolygonHead.Effects.FadeTransitionEffect
...
public class FadeTransitionEffect(GraphicsDevice iDevice) : TransitionEffect(iDevice, FadeTransitionEffectCode.CODE, (EffectPool) null)
{
