...
// Type: Magicka.GameLogic.Entities.Abilities.SpecialAbilities.Arcanebolt
...
public class Arcanebolt : SpecialAbility
{
  ...
  public Arcanebolt(Magicka.Animations iAnimation)
    : base(iAnimation, "#specab_arcane".GetHashCodeCustom())
  {
  ...
  public override bool Execute(ISpellCaster iOwner, PlayState iPlayState)
  {
    ...
    ProjectileSpell.SpawnMissile(ref missileInstance, iOwner, 0.15f, ref translation, ref result, ref this.mSpell, 4f, 1);
