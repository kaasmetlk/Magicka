...
// Type: Magicka.GameLogic.Entities.Abilities.SpecialAbilities.HolyGrenade
...
public class HolyGrenade : SpecialAbility
{
  ...
  public HolyGrenade(Magicka.Animations iAnimation)
    : base(iAnimation, "#specab_tsal_antioch".GetHashCodeCustom())
  {
    if (HolyGrenade.sModel != null)
      return;
    lock (Magicka.Game.Instance.GraphicsDevice)
      HolyGrenade.sModel = Magicka.Game.Instance.Content.Load<Model>("Models/Missiles/holy_handgrenade");
  }
  ...
  public override bool Execute(ISpellCaster iOwner, PlayState iPlayState)
  {
    ...
    HolyGrenade.SpawnGrenade(ref missileInstance, iOwner, ref translation, ref result);
    ...
    if (NetworkManager.Instance.State != NetworkState.Offline)
      ...
      {
        Type = SpawnMissileMessage.MissileType.HolyGrenade,
    ...
    ref Vector3 iVelocity)
  {
    ...
    iConditions[0].Add(new EventStorage(new PlayEffectEvent(HolyGrenade.EFFECT, false, true)));
    iConditions[0].Add(new EventStorage(new PlaySoundEvent(Banks.Additional, HolyGrenade.SOUND, false)));
    ...
    iConditions[1].Add(new EventStorage(new PlayEffectEvent(HolyGrenade.EFFECT, false, true)));
    iConditions[1].Add(new EventStorage(new PlaySoundEvent(Banks.Additional, HolyGrenade.SOUND, false)));
    ...
    iConditions[2].Add(new EventStorage(new PlayEffectEvent(HolyGrenade.PULSE, true)));
    iMissile.Initialize(iOwner as Entity, HolyGrenade.sModel.Meshes[0].BoundingSphere.Radius * 0.75f, ref iPosition, ref iVelocity, HolyGrenade.sModel, iConditions, false);
