...
// Type: Magicka.GameLogic.Entities.Abilities.SpecialAbilities.StopCharge
...
public class StopCharge : SpecialAbility, IAbilityEffect
{
  ...
  public static StopCharge GetInstance()
  {
    ...
    StopCharge instance = StopCharge.sCache[StopCharge.sCache.Count - 1];
  ...
  public StopCharge(Magicka.Animations iAnimation)
  ...
  public void Update(DataChannel iDataChannel, float iDeltaTime)
  {
    ...
    {
      this.mCharging = false;
      GreaseSplash.Instance.Execute((ISpellCaster) this.mOwner, this.mPlayState);
      if ((double) this.mTTL > (double) this.TIME - (double) this.STOP_CHARGE)
        this.mOwner.GoToAnimation(Magicka.Animations.special2, 0.1f);
      this.mTTL = 0.0f;
    }
