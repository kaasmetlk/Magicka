...
// Type: Magicka.GameLogic.Entities.Abilities.SpecialAbilities.Fireflask
...
public class Fireflask : SpecialAbility
{
  ...
  public Fireflask(Magicka.Animations iAnimation)
    : base(iAnimation, "#specab_fireflask".GetHashCodeCustom())
  {
    if (Fireflask.sModel != null)
      return;
    lock (Magicka.Game.Instance.GraphicsDevice)
      Fireflask.sModel = Magicka.Game.Instance.Content.Load<Model>("Models/Items_Wizard/weapon_fireflask");
  }
  ...
  public override bool Execute(ISpellCaster iOwner, PlayState iPlayState)
  {
    ...
    Fireflask.SpawnGrenade(ref missileInstance, iOwner, ref translation, ref result);
    ...
    if (NetworkManager.Instance.State != NetworkState.Offline)
      ...
      {
        Type = SpawnMissileMessage.MissileType.FireFlask,
    ...
    ref Vector3 iVelocity)
  {
    ...
    iConditions.Clear();
    Damage iDamage1 = new Damage(AttackProperties.Damage, Elements.Fire, 470f, 1f);
    ...
    iConditions[0].Add(new EventStorage(new PlayEffectEvent(Fireflask.EFFECT, false, true)));
    iConditions[0].Add(new EventStorage(new PlaySoundEvent(Banks.Spells, Fireflask.SOUND, false)));
    iConditions[0].Add(new EventStorage(new BlastEvent(2f, iDamage2)));
    iConditions[0].Add(new EventStorage(new BlastEvent(2f, iDamage1)));
    ...
    iConditions[1].Add(new EventStorage(new PlayEffectEvent(Fireflask.EFFECT, false, true)));
    iConditions[1].Add(new EventStorage(new PlaySoundEvent(Banks.Spells, Fireflask.SOUND, false)));
    iConditions[1].Add(new EventStorage(new BlastEvent(2f, iDamage2)));
    iConditions[1].Add(new EventStorage(new BlastEvent(2f, iDamage1)));
    ...
    iConditions[3].Condition.Threshold = 20f;
    iConditions[3].Add(new EventStorage(new PlayEffectEvent(Fireflask.EFFECT, false)));
    iConditions[3].Add(new EventStorage(new PlaySoundEvent(Banks.Spells, Fireflask.SOUND, false)));
    iConditions[3].Add(new EventStorage(new BlastEvent(2f, iDamage2)));
    iConditions[3].Add(new EventStorage(new BlastEvent(2f, iDamage1)));
    ...
    iConditions[2].Add(new EventStorage(new PlayEffectEvent(Fireflask.PULSE, true)));
    iMissile.Initialize(iOwner as Entity, Fireflask.sModel.Meshes[0].BoundingSphere.Radius * 0.75f, ref iPosition, ref iVelocity, Fireflask.sModel, iConditions, false);
