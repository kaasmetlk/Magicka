...
// Type: Magicka.GameLogic.Entities.Abilities.SpecialAbilities.Charm
...
public class Charm : SpecialAbility
{
  ...
  public Charm(Magicka.Animations iAnimation)
  ...
  public override bool Execute(ISpellCaster iOwner, PlayState iPlayState)
  {
    ...
    character.Charm((Entity) (iOwner as Character), 15f, Charm.CHARM_EFFECT);
