...
// Type: Magicka.GameLogic.Entities.Abilities.SpecialAbilities.AlucartDeathExplosion
...
{
  private const float VELOCITY_MODIFIER = 0.0f;
  ...
  public AlucartDeathExplosion(Magicka.Animations iAnimation)
  ...
  public override bool Execute(ISpellCaster iOwner, PlayState iPlayState)
  {
    ...
    if (iOwner is Avatar && (iOwner as Avatar).Template.ID == AlucartDeathExplosion.ROBE_ROGUE)
      ++translation.Y;
    Vector3.Multiply(ref result, 0.0f, out result);
