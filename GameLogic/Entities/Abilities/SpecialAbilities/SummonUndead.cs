...
// Type: Magicka.GameLogic.Entities.Abilities.SpecialAbilities.SummonUndead
...
public class SummonUndead : SpecialAbility
{
  ...
  public SummonUndead(Magicka.Animations iAnimation)
    : base(iAnimation, "#specab_spirit".GetHashCodeCustom())
  {
