...
// Type: Magicka.GameLogic.Entities.Bosses.BossInitializeMessage
...
public struct BossInitializeMessage : ISendable
{
  ...
  public PacketType PacketType => PacketType.BossInitialize;
  ...
  public static unsafe void ConvertTo(ref BossInitializeMessage iMsg, void* oValue)
  {
  ...
  public static unsafe void ConvertFrom<T>(
    ushort iType,
    void* iValue,
    out BossInitializeMessage oMsg)
    where T : struct
  {
